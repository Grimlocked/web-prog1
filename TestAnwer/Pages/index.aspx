<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="webTest.Pages.index" %>
...
<body style="background-color:#728287; color:whitesmoke;">
    ...
    <form id="form1" action="reader.aspx?p=i" runat="server">
        <p>Welcome to your Test, please create an account to continue</p>
        <div>
            ...
            Password:<asp:TextBox ID="pass" TextMode="Password" runat="server" /><br />
              <asp:Button ID="sendItBtn" Text="Submit Form" CssClass="btn btn-primary" runat="server" />
        </div>
    </form>
        </center>
</body>
